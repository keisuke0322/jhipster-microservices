...
export const PostDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.gateway.post.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.postPost.delete.question">
        <Translate contentKey="gatewayApp.postPost.delete.question" interpolate={{ id: postEntity.id }}>
