...
export const CategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.categoryCategory.delete.question">
        <Translate contentKey="gatewayApp.categoryCategory.delete.question" interpolate={{ id: categoryEntity.id }}>
