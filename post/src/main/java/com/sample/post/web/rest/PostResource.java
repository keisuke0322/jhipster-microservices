...
import com.sample.post.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.sample.post.domain.Post}.
 */
@RestController
...
public class PostResource {
    ...
    private static final String ENTITY_NAME = "postPost";
    ...
    public ResponseEntity<PostDTO> createPost(@Valid @RequestBody PostDTO postDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/posts/" + postDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, postDTO.getId().toString()))
            .body(postDTO);
    }
