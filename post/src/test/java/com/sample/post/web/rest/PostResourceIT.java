package com.sample.post.web.rest;

import static com.sample.post.domain.PostAsserts.*;
import static com.sample.post.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.sample.post.IntegrationTest;
...
class PostResourceIT {
    ...
    public static Post createEntity() {
        return new Post().post(DEFAULT_POST).name(DEFAULT_NAME);
    }
    ...
    public static Post createUpdatedEntity() {
        return new Post().post(UPDATED_POST).name(UPDATED_NAME);
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.post(UPDATED_POST).name(UPDATED_NAME);
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.name(UPDATED_NAME);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.post(UPDATED_POST).name(UPDATED_NAME);
